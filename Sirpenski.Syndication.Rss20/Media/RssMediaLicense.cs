...
namespace Sirpenski.Syndication.Rss20
{
    ...
    /// <summary>
    /// The RssMediaLicense object specifies the machine-readable license associated with the content.
    /// </summary>
    [Serializable]
    public class RssMediaLicense
    {
