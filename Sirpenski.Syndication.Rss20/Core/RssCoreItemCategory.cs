...
// FileName:   RssCoreItemCategory.cs
...
namespace Sirpenski.Syndication.Rss20.Core
{
    ...
    /// <summary>
    /// The category object identifies a category or tag to which the item belongs (optional).
    /// </summary>
    [Serializable]
    public class RssCoreItemCategory
    {
        ...
        /// <summary>
        /// The category or tag to which this item applies
        /// </summary>
        ...
        // -------------------------------------------------------------------------------
        /// <summary>
        /// Gets the category properties as an XElement
        /// </summary>
        ...
        // -------------------------------------------------------------------------------
        /// <summary>
        /// Loads the properties of the category from an XElement 
        /// </summary>
